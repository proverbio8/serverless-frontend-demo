...
export const validateTagLoading = createAction(ActionTypes.VALIDATE_TAG_LOADING);
export const validateTagSuccess = createAction<TagValidateResponse>(ActionTypes.VALIDATE_TAG_SUCCESS);
export const validateTagError = createAction<string>(ActionTypes.VALIDATE_TAG_ERROR);
